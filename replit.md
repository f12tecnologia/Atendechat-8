...
## Recent Changes
- **Dec 28, 2025**: Fixed 3 critical issues - (1) Added ticket.reload with User include in SendWhatsAppMessage before formatBody to ensure attendant names appear correctly in all messages, (2) Enhanced ticket.reload in verifyQueue, handleRating, and handleChartbot for automatic messages, (3) Verified MessagesList correctly processes mediaUrl for audio/image/document attachments with /public/ prefix normalization.
