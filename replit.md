...
## Recent Changes
- **Dec 28, 2025**: Enhanced attendant name fix - added ticket.reload with User include in verifyQueue, handleRating, and handleChartbot functions to ensure ticket.user is always loaded before sending automatic messages. This guarantees {{atendente}}, {{attendant}}, {{user}}, {{userName}} variables always have data available.
